    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6 bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] [background-size:16px_16px]">
      <div className="max-w-md w-full">
        <div className="text-center mb-10">
          ...
          <p className="text-slate-500 mt-2">Accede a tu panel de control de logÃ­stica</p>
        </div>
        ...
        <div className="bg-white p-8 rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-100">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-1">
              <label className="text-sm font-semibold text-slate-700 ml-1">ContraseÃ±a</label>
              <div className="relative">
          ...
          <div className="mt-8 pt-8 border-t border-slate-100 text-center">
            <p className="text-sm text-slate-500">
              Â¿Olvidaste tu contraseÃ±a? <span className="text-blue-600 font-semibold cursor-pointer">RecupÃ©rala</span>
            </p>
          </div>
        </div>
      </div>
